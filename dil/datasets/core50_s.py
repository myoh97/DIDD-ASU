...
if os.path.exists('/root/dataset/DIL/core50_128x128'):
    base_path = '/root/dataset/DIL/core50_128x128'
else:
    base_path = '/workspace/datasets/DIL/core50_128x128'
...
class Core50(ImageFolder):
    ...
    def find_classes(self, directory: str):
        ...
        exclude_folders = ['@eaDir', '.DS_Store']
        classes_to_remove = [cls for cls in classes if cls in exclude_folders]
...
class SequentialCore50Small(ContinualDataset):
    NAME = 'seq-core50-s'
    ...
    @staticmethod
    def get_backbone():
        return MNISTMLP(3 * 32 * 32, SequentialCore50Small.N_CLASSES_PER_TASK)
    ...
    def get_minibatch_size():
        return SequentialCore50Small.get_batch_size()
...
class TransferCore50(ContinualDataset):
    ...
    @staticmethod
    def get_backbone():
        return MNISTMLP(3 * 128 * 128, SequentialCore50Small.N_CLASSES_PER_TASK)
