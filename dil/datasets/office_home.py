...
base_path = '/root/dataset/DIL/Office-Home/OfficeHome'

import ipdb

class OfficeHome(ImageFolder):
    def __init__(self, root, transform=None, target_transform=None):
        super(OfficeHome, self).__init__(root, transform, target_transform)
        self.class_names = [
            ''
        ]
...
class SequentialOfficeHome(ContinualDataset):
    NAME = 'officehome'
    ...
    def __init__(self, args: Namespace, distill):
        ...
        self.task_name = ['Art', 'Clipart', 'Product', 'RealWorld']
        self.setup_loaders()
