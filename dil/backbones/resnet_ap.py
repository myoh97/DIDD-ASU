...
import sys
sys.path.append("/root/workplace/DD/DiDD")
from models.resnet_ap import ResNetAP

from dil.backbones.utils.continual_backbone import FwdContinualBackbone
from dil.backbones.utils.modules import xavier

import ipdb

class ResNet_AP(FwdContinualBackbone):
    NAME = 'resnet_ap'
    def __init__(self, indim, hiddim, outdim, args):
        ...
        self.net = ResNetAP(dataset='core50',depth=18, width=1.0, num_classes=outdim, norm_type='instance', size=128, nch=3)
...
if __name__ == '__main__':
    model = ResNet_AP(num_classes=50)
